...
from app.visao.yolov3.yolov4 import *
...
def detect_image(Yolo, original_image, input_size=416, CLASSES=YOLO_COCO_CLASSES, score_threshold=0.3, iou_threshold=0.45):
